...
0.4 新增第二个顶层工作模式“品牌级精修”。它把上传图片视为已经完成主体、产品、构图和场景设计的成稿，只分析画质、真实质感、皮肤与材质细节、光影调性和技术完成度。

上传成稿后，可以补充一句想要的画面调性，然后生成整图精修提示词。提示词由服务端固定加入人物、产品、装备、文字、构图、裁切和场景结构的不可变边界，再复制到固定的图片编辑或生图工具执行。
